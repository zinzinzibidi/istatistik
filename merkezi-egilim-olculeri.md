...
$$ \text{Bilesik Faiz} = [(1 + 0.10)(1 + 0.20)(1 + 0.15)]^{1 \over 3} - 1 = 1.518^{1 \over 3} - 1 \approx 0.1493 \approx \text{%}14.93 $$
...
$$ \text{Bilesik Faiz} = [(1 + 0.1493)(1 + 0.1493)(1 + 0.1493)]^{1 \over 3} - 1 = 1.518^{1 \over 3} - 1 \approx 0.1493 \approx \text{%}14.93 $$
